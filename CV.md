...
**Full Stack & Mobile Developer — TypeScript · Next.js · Node.js**

- Email: nelsonkenzotamashiro@gmail.com
- Phone: +55 (11) 97515-3417
- LinkedIn: https://www.linkedin.com/in/nelson-kenzo-tamashiro
- GitHub: https://github.com/gitnlsn
- Portfolio: https://play.google.com/store/apps/developer?id=nelson+kenzo+tamashiro
...
- Engineered **5 production AI agents** automating human-staffed workflows for FutureSecureAi's commercial agent platform — including **Jack**, a voice-based interview agent (**retell.ai**) designed to conduct phone screenings for open job positions and take on the *triagem* (screening) step of the hiring funnel, **handling 200+ screenings/month** at peak.
- Onboarded into a large, unfamiliar legacy codebase and integrated **8+ third-party APIs** — extending capability without destabilizing existing flows; debugged and resolved cross-system issues end-to-end.
- Collaborated across engineering to scope work with development managers, pair on hard problems, and unblock peers through code review and pair programming.
- **Stack:** TypeScript, Node.js, LangChain, Vercel AI SDK, Mastra, retell.ai, Gemini Flash, third-party API integrations
...
### Quality24 — Full Stack Developer
*Apr 2019 – Mar 2020 · Remote*

- Developed **Android (Java)** screens for a patient-bedside hospitalization-attendance system used in clinical workflows; shipped to an initial **100-device pilot rollout** with a healthcare provider.
- Authored **150+ unit tests** for the **Node.js + Postgraphile** (GraphQL-over-Postgres) backend, **lifting backend coverage to ~80%** and hardening regression safety as the team shipped new endpoints.
- **Stack:** Java (Android), Node.js, Postgraphile, GraphQL, PostgreSQL
...
- Research scholarship — **FAPESP** *(2016 – 2017)*: worked on **fluid simulation**, applying numerical methods and scientific computing.
- Research scholarship — **PIBIC** *(2014 – 2015)*: implemented a **probabilistic algorithm** to analyze event relationships in critical systems.

---

## Projects

### Voile Drift — AI-powered calendar insights
*Google Play*

- Personal Android app that logs the user's events with rich descriptions, then runs **Gemini Flash** over them to surface relationships between events and generate insights.
- **Stack:** Kotlin, Android, Gemini Flash API

### Vera — menstrual cycle forecasting
*Google Play*

- Mobile app that predicts and tracks menstrual cycles from user-logged history.
- **Stack:** Kotlin, Android

### Lontra Ágil — AI study companion for Brazilian *concursos públicos*
*In development · team project*

- Developing a study-prep platform: imports public-exam PDFs, uses **Gemini Flash** to parse them, and auto-generates practice questions for students preparing for public-sector entrance exams.
- Working with a small team — covering product, ingestion pipeline, and AI evaluation loop.
- **Stack:** TypeScript, Next.js, React Native, Gemini Flash API
...
- **Rocketseat — Ignite** *(2021)*: building full-stack applications
